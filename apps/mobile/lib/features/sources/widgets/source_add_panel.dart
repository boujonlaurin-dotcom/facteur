...
import 'source_result_card.dart';
import 'source_result_skeleton.dart';

/// Panneau réutilisable « ajouter une source » : champ de recherche + filtres
/// type de contenu + liste de résultats + ouverture de la modale détail.
///
/// Hébergé par `AddSourceScreen` (full-screen) et par le sheet du flow Veille
/// Step 3 (`VeilleAddSourceSheet`). Les variations cosmétiques (intro, gems,
/// nudge post-add) sont contrôlées par les paramètres `show*`.
class SourceAddPanel extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SourceAddPanel> createState() => _SourceAddPanelState();
}

class _SourceAddPanelState extends ConsumerState<SourceAddPanel> {
  ...
  Widget _buildSearchIntro(FacteurColors colors) {
    return Column(
