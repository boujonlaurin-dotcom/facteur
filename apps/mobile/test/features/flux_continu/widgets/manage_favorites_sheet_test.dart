...
CustomTopicInterest _topic(String id, String name, {String slugParent = 'tech'}) =>
    CustomTopicInterest(
      id: id,
      topicName: name,
...
void main() {
  ...
  testWidgets('rend le titre + les deux sections + AJOUTER + GÉRER',
    ...
    // Éditorial visible par défaut dans l'Essentiel.
  ...
  testWidgets(
    ...
    final essentielY =
        tester.getTopLeft(find.text('CHAQUE MATIN DANS TON ESSENTIEL')).dy;
    final flanerY =
        tester.getTopLeft(find.text('TES ONGLETS POUR EXPLORER')).dy;
  ...
  testWidgets('« Hors Tournée du jour » apparaît au-delà de 5 sections Essentiel',
      (tester) async {
    await _openSheet(
      tester,
