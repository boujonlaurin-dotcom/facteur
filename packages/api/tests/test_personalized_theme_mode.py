...
# et le boost ORDER BY user_subtopics dans `_get_candidates`. Depuis le fix
# curation 2026-06-01 (Fix #1), ce mode route vers le PillarScoringEngine
# (chemin scoré) — il saute l'early-return chrono pur ET la compression
# regroupement/diversification. La compression collapsait 40+ candidats à 2-3
# articles ; le chemin scoré classe par qualité/source/pertinence/fraîcheur sans
# compresser. Le routage et le reclassement sont couverts par
# tests/test_thematic_curation.py + scripts/prove_thematic_scoring.py.
# ---------------------------------------------------------------------------
