...
async def test_parse_entry_youtube(sync_service):
    ...
    entry.__contains__.side_effect = lambda k: (
        k in MOCK_YOUTUBE_ENTRY or k == "media_group"
    )
    ...
    media_group.media_thumbnail = [
        {"url": "https://img.youtube.com/vi/123/hqdefault.jpg"}
    ]
...
async def test_save_content_deduplication(sync_service, mock_session):
    ...
    assert mock_existing.content_quality == "none"
