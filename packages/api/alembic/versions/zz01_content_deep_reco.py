...
NB : cette révision **fusionne** les deux heads laissés sur ``main``
(``pn01_server_push`` et ``sc01_drop_ucs_excl_idx``) en plus de créer la table,
ramenant la chaîne à exactement 1 head.
"""
