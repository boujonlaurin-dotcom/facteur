...
class Top3Selector:
    ...
    def select_top3(
        ...
        logger.info(
            ...
            has_followed_source=any(item.top3_reason == "Source suivie" for item in result)
        )
