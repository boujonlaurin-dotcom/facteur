...
STOPWORDS = {
    ...
    "peuvent", "pourraient", "devrait", "faut", "veut", "vont", "doit", "veux", "vouloir",
    # Conjunctions & adverbs
    "mais", "ou", "donc", "ni", "car", "si", "alors", "quand", "comme", "après", "avant",
    "encore", "aussi", "même", "autre", "autres", "peu", "beaucoup", "trop", "assez",
    "vraiment", "toujours", "jamais", "souvent", "parfois",
    # Question words
    "pourquoi", "comment", "quand", "combien",
    # Generic/common words that don't indicate topic
    "monde", "année", "années", "nouveau", "nouvelle", "nouveaux", "nouvelles",
    "grand", "grande", "grands", "grandes", "petit", "petite", "petits", "petites",
    "premier", "première", "dernier", "dernière", "deux", "trois", "quatre", "cinq",
    "face", "contre", "vers", "entre", "selon", "côté", "fois", "temps", "jour", "jours",
    "grâce", "travers", "lors", "depuis", "jusque", "durant", "pendant", "suite",
    "faut", "fallait", "faudrait", "doit", "doivent", "devrait", "devraient",
    "peut", "peuvent", "pourrait", "pourraient", "sait", "savent", "veut", "veulent",
    # News filler
    "informations", "info", "infos", "article", "articles", "savoir", "retenir",
    "breaking", "urgent", "exclusif", "exclusive", "dernière", "dernières", "heure", "heures",
    "minute", "minutes", "live", "direct", "video", "vidéo", "photo", "photos", "images",
    "podcast", "interview", "analyse", "décryptage", "explications", "enquête", "dossier",
    "révèle", "montre", "indique", "suggère", "affirme", "estime", "pense", "croit",
    # Very common non-topical words
    "président", "gouvernement", "ministre", "pays", "nation", "société", "économie",
    "politique", "histoire", "science", "culture", "international", "national", "local",
    "victimes", "personnes", "gens", "hommes", "femmes", "enfants", "jeunes", "vieux",
    "villes", "ville", "région", "zone", "secteur", "domaine", "partie", "ensemble",
    "système", "question", "problème", "solution", "idée", "projet", "plan", "mesure",
    "effet", "impact", "conséquence", "résultat", "cause", "raison", "objectif", "but",
    "manière", "façon", "forme", "type", "sorte", "genre", "niveau", "degré", "point",
    "occident", "occidental", "orientale", "europe", "européen", "européenne", "américain",
}
...
class StoryService:
    ...
    async def cluster_hybrid(
        ...
        for root, cluster_articles in clusters.items():
            sources_in_cluster = set(a.source_id for a in cluster_articles)
