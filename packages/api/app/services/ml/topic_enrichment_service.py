...
class DisambiguationCandidate:
    """A single disambiguation candidate returned by the LLM."""
...
DISAMBIGUATION_SYSTEM_PROMPT = f"""Tu es un assistant de désambiguïsation pour une app d'actualités.

L'utilisateur te donne un terme libre. Tu dois identifier s'il est ambigu et retourner 1 à 3 interprétations possibles.

Pour chaque interprétation, retourne :
- "canonical_name": le nom complet et précis
- "entity_type": "PERSON" | "ORG" | "EVENT" | "LOCATION" | "PRODUCT" ou null si c'est un sujet général
- "description": une courte description (1 phrase) pour différencier
- "slug_parent": le slug le plus pertinent parmi cette liste :
...
Exemple pour "Apple" :
[{{"canonical_name": "Apple", "entity_type": "ORG", "description": "Entreprise technologique (iPhone, Mac, services)", "slug_parent": "tech"}}, {{"canonical_name": "Apple", "entity_type": null, "description": "Fruit, alimentation et agriculture", "slug_parent": "food"}}]
