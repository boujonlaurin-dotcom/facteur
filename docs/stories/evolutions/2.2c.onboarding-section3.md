...
> **Parent Story**: [[../core/2.2.onboarding-section1.md]]  
> **Type**: Evolution
...
graph TD
    ...
    S3_INTRO --> Q9[Q9: Thèmes<br/>Multi-select]
    Q9 --> VALIDATE{Au moins<br/>1 thème?}
    ...
    Q12 --> CHECK_GAMIF{Gamification<br/>activée?}
