...
- [ ] **Task 1: Content Interaction API**
...
- [ ] **Task 3: Tests**
  - [ ] Test unitaire : marquer un contenu comme `CONSUMED`.
  - [ ] Vérifier qu'il est bien sauvegardé en base.
  - [ ] Vérifier qu'il est exclu du prochain appel `/api/feed` (Test d'intégration).
