...
4. ✅ Tap sur perspective ouvre l'article externe.
5. ✅ Loading state pendant la recherche.
6. **Pop-up Explicatif FQS** : Au tap sur l'icône de fiabilité d'une source, une modale explique le score FQS (Indépendance etc.). [New]
