...
|------|------|-------------|
| `is_liked` | bool | Article aimé (❤️). Booste les `user_subtopics.weight` des topics associés (+0.15) |
...
| `POST` | `/contents/{id}/like` | Aimer un article (❤️) + boost subtopic +0.15 (Story 4.1f) |
...
// TOPIC_MATCH = 6 points, weight ∈ [0.1, 3.0]
